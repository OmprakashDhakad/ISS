/*
     ...
     Compile thr code  : g++ 2015kucp1028_assignment08_des.cpp 
     run the code      : ./a.out
     
     Example output  :  Enter the plain text of 16bits in hexadecimal form  : 0123476519ABDCAD
				Enter the key of 16bits in hexadecimal form : 0123476519ABDCAA
				OUTPUT AFTER ROUND - > 1
				19ABDCAD82B9FD6B
				OUTPUT AFTER ROUND - > 2
				82B9FD6B8E6E8B32
				OUTPUT AFTER ROUND - > 3
				8E6E8B329C916338
				OUTPUT AFTER ROUND - > 4
				9C9163387906E7B4
				OUTPUT AFTER ROUND - > 5
				7906E7B4F6C15EBE
				OUTPUT AFTER ROUND - > 6
				F6C15EBEE7C52A81
				OUTPUT AFTER ROUND - > 7
				E7C52A81129EC70B
				OUTPUT AFTER ROUND - > 8
				129EC70B283B454E
				OUTPUT AFTER ROUND - > 9
				283B454E17CD9E71
				OUTPUT AFTER ROUND - > 10
				17CD9E71B3EC608B
				OUTPUT AFTER ROUND - > 11
				B3EC608B7B8C8665
				OUTPUT AFTER ROUND - > 12
				7B8C8665564E0A72
				OUTPUT AFTER ROUND - > 13
				564E0A72F9A7C20E
				OUTPUT AFTER ROUND - > 14
				F9A7C20E113020BA
				OUTPUT AFTER ROUND - > 15
				113020BA09AEBC4B
				OUTPUT AFTER ROUND - > 16
				09AEBC4BA774B3DB
...
int main()
{
        ...
        cout<<"Enter the plain text of 16bits in hexadecimal form  : ";
        cin>>p;
        
        //check wheather a string is hexadecimal or not 
        if(p.length()!=16)
        {
        ...
        int key1[64];
        pr:;
                cout<<"Enter the key of 16bits in hexadecimal form : ";
                cin>>ke;
         if(ke.length()!=16)
         {
   ...
   int per[32]={16 ,  7 , 20  ,21,
    ...
    //Start  Encryption algorithm of Des
          while(round--)
         {
            rtem=r;
            t=1;
            string ep="",xorout="",sout="",soutt;
            //the expansion permutation box
            ep+=r[31];
            for(i=0;i<32;i++)
            {
                if((t+1)%6==0)
